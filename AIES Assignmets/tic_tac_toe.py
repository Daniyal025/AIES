...
class GeniusComputerPlayer(Player):
    ...
    def minimax(self, state, player):
        ...
        for move in state.available_moves():
            ...
            sim_score, _ = self.minimax(state, opponent)
            state.board[move] = ' '
    ...
    def minimax_alpha_beta(self, state, player, alpha=-math.inf, beta=math.inf):
        ...
        for move in state.available_moves():
            state.make_move(move, player)
            sim_score, _ = self.minimax_alpha_beta(state, opponent, alpha, beta)
            state.board[move] = ' '
            state.current_winner = None
...
if __name__ == '__main__':
    ...
    print("""
The Below Performance Output is from the game played between 
random inputs and Genius Computer using Minimax and Alpha Beta Pruning Algorithm.""")
    compare_performance()
